...
public class AccountPage {
	...
	@FindBy(xpath = "//h2[normalize-space()='Account Services']") WebElement accountServicesLabel;
	@FindBy(xpath = "//h2[normalize-space()='Account Services']/../ul/li") List<WebElement> accountServicesList;
